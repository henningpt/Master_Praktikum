...
Schaltung \ref{fig:gleichrichterdiode}
...
\begin{figure}
  ...
  Diode und einem Tiefpass nach Schaltung \ref{fig:gleichrichterdiode}.}
...
Signal mit durch einen Schwingkreis nach Abbildung \ref{fig:flankenmodulator}.}
