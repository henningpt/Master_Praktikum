...
is periodically changed by a \textbf{piezzo element} or changing
the left/right angle of the grating.
...
this experiment, lead to the spectrum shown in figure \ref{fig:rubdium_spectrum}.

\begin{figure}
  \centering
  \includegraphics{rubidium_spectrum.png}
  \caption{Expected absorption spectrum of $Rb^{87}$ and $Rb^{85}$.\cite{sample}}
  \label{fig:rubidum_spectrum}
\end{figure}
...
when a crystal(or other solid materials) is deformed. The inverse piezo-electrical effect describes
