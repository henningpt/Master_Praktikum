...
the excited state would only be populated with the same probability as the ground state.  % oder den satz vllt einfach streichen
This would not be enough in order to ensure mostly stimulated emission.
...
the number of knots $m$.
For one mode exists the following relation
\begin{align}
...
% are coated to increase or decrease the facet reflectivity
