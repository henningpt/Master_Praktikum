...
\begin{figure}
  ...
  \caption{Two different typical strutures profiles of a diode laser chip.\cite{V61}}
  \label{fig:chip}
\end{figure}
...
\begin{figure}
  ...
  \label{injectioncurrent_wavelength}
\end{figure}
\FloatBarrier
...
the first order is send back. Figure \ref{fig:gain_overview}
...
is periodically changed by a \textbf{piezo element} or changing
